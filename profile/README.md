# DDMJC - Diffusion Decision Model Journal Club
...
DDMJC (Diffusion Decision Model Journal Club) is an online literature sharing and exchange event initiated by the **Drift-Diffusion Model (DDM)** interest group.

Our purpose is to communicate and learn about DDM and related models with students and colleagues both domestically and internationally through online means. The event primarily focuses on:

- 🧠 **The basic knowledge of the drift-diffusion model and related research**
- 📊 **The application of DDM in decision-making tasks, code implementation, and mathematical principles**
- 💻 **Discussions on cognitive modeling and psychological methods**

---

## 🤝 Collaborating Organizations

The event has received strong support from:

| Organization | Description |
|--------------|-------------|
| **COSN** | Chinese Open Science Network |
| **CCPN** | Chinese Computational Psychiatry Network |
...
|------|-------------|------|
| Wanke Pan | Nanjing Normal University (PhD) | Organizer |
| Xiujuan Wen | South China Normal University (PhD) | Organizer |
...
| Qiyang Nie | University of Macau (PhD) | Advisor |
...
![GitHub Contributors](https://img.shields.io/github/contributors/DDMJournalClub/DDM_Journal_Club)
![GitHub Last Commit](https://img.shields.io/github/last-commit/DDMJournalClub/DDM_Journal_Club)
![GitHub Language Count](https://img.shields.io/github/languages/count/DDMJournalClub/DDM_Journal_Club)
...
*🔄 Last Updated: 2026-03-18 | 最后更新: 2026-03-18*
